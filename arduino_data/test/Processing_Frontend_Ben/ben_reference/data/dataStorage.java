  ...
  */
  ...
  public static void main(String[] args) {
    ...
    for (int i = 0; i < 60; i++) {
        ...
        dataArray[i].setTemps(68, 59, 105);
        float[] tempsF = dataArray[i].getTempsFarenheit();
        System.out.println("Farenheit: "+ tempsF[0] + ", " + tempsF[1] + ", " + tempsF[2]);
        System.out.println(dataArray[i].isShutdown());
    	System.out.println("---------------------------");
    }
  }
