...
class Monitor():
	...
	def setupButtons(self):
		...
		TripPointEntryButton = tk.Button(self.TripPointFrame_3, text="OK", activebackground=GREEN, font=40, command=lambda: self.application.TripPointInputting(self.voltageEntry.get(), self.currentEntry.get(), self.temperatureEntry.get(), self.selected))
		...
		self.toggleManualSwitchButton = tk.Button(manualConfigFrame, text="ON", activebackground=GREEN, font=40, command=lambda: self.application.manualSwitchInputting(self.selected))
	...
	def setupQueryButtons(self):
		...
		v1Button = tk.Button(queryButtonFrame, text="V1", activebackground=GREEN, font=30, command=lambda: self.graph.setField('voltage_1'))
		v1Button.pack(side="left")
		v2Button = tk.Button(queryButtonFrame, text="V2", activebackground=GREEN, font=30, command=lambda: self.graph.setField('voltage_2'))
		v2Button.pack(side="left")
		v3Button = tk.Button(queryButtonFrame, text="V3", activebackground=GREEN, font=30, command=lambda: self.graph.setField('voltage_3'))
		v3Button.pack(side="left")
		c1Button = tk.Button(queryButtonFrame, text="C1", activebackground=GREEN, font=30, command=lambda: self.graph.setField('current_1'))
		c1Button.pack(side="left")
		t1Button = tk.Button(queryButtonFrame, text="T1", activebackground=GREEN, font=30, command=lambda: self.graph.setField('temperature_1'))
		t1Button.pack(side="left")
		t2Button = tk.Button(queryButtonFrame, text="T2", activebackground=GREEN, font=30, command=lambda: self.graph.setField('temperature_2'))
		t2Button.pack(side="left")
		t3Button = tk.Button(queryButtonFrame, text="T3", activebackground=GREEN, font=30, command=lambda: self.graph.setField('temperature_3'))
		t3Button.pack(side="left")
		t4Button = tk.Button(queryButtonFrame, text="T4", activebackground=GREEN, font=30, command=lambda: self.graph.setField('temperature_4'))
		t4Button.pack(side="left")
		t5Button = tk.Button(queryButtonFrame, text="T5", activebackground=GREEN, font=30, command=lambda: self.graph.setField('temperature_5'))
		t5Button.pack(side="left")
		t6Button = tk.Button(queryButtonFrame, text="T6", activebackground=GREEN, font=30, command=lambda: self.graph.setField('temperature_6'))
