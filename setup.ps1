...
# When prompted, type "Y".
python Main.py
# After you run this command, the application should load onto your screen. 

# Disclaimer: This script has only been tested in Windows 10.
# Disclaimer: Tf you do not have a compatible hardware system setup to run in tandem with the application, it will lack most of its functionality.
